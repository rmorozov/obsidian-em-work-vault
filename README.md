...
Start with [the design brief](docs/design.md) and [local setup steps](docs/setup.md). `0. PeriodicNotes/Templates/` contains LifeOS Daily and Weekly drafts, while `Templates/` holds management note drafts; `HOME.md` contains Dataview management views. The weekly template reuses LifeOS `BulletRecordListByTime` for live collection of Daily Record bullets.
